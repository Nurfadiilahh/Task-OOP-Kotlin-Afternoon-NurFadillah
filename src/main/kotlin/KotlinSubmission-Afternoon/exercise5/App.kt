...
fun main() {
     ...
     */
    // Mengisi data profil
    Nama.setProfile("Sulta Hasanudin", 20, 180)
     ...
     *
     */
    // Menampilkan profil pahlawan sebelum melakukan aktivitas
    Nama.profile()
    ...
    **/
    ...
    // Melakukan aktivitas sesuai dengan kriteria
    repeat(3) { Nama.jalan() }
    repeat(1) { Nama.lari() }
    repeat(5) { Nama.makan() }
    repeat(1) { Nama.minum() }
    repeat(5) { Nama.lompat() }
    repeat(3) { Nama.duduk() }
     ...
     *
     */
    // Menampilkan profil setelah beberapa kegiatan
    Nama.profile()
